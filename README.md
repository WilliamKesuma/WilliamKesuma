...
Beyond mobile, I bring full-stack range — AWS serverless architecture and time-series forecasting — so I can work closely with backend and data teams while owning the iOS experience end to end.

I'm also deliberately growing alongside AI tooling — using models like Claude, Gemini, and Copilot inside AI-native editors (Antigravity, Cursor) to move faster, and shipping to Vercel to close the loop from prototype to production.
...
## 🤖 Building & Growing with AI

I treat AI tools as a skill to develop deliberately, not just a shortcut — using them to work faster *and* to understand the systems well enough to build with them.
...
<p align="Leading">
  ...
  <img src="https://img.shields.io/badge/GitHub_Copilot-000000?logo=githubcopilot&logoColor=white"/>
  <img src="https://img.shields.io/badge/Cursor-000000?logo=cursor&logoColor=white"/>
  <img src="https://img.shields.io/badge/Antigravity-4285F4?logo=google&logoColor=white"/>
  <br/>
</p>

- **Workflow speed** — pairing with Claude, Gemini, and Copilot inside Cursor and Antigravity to move from idea to working code faster
- **Building AI-native features** — integrating AI directly into my own apps (not just using AI to write code, but shipping AI-powered functionality to users)
- **Systems literacy** — going deep enough on how these tools work to talk about them from either the engineering or the product/BA side
